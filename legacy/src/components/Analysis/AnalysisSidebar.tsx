import {
  ...
  BlunderMeter,
  MovesByRating,
  ExpectedWinrateControls,
  ExpectedWinrateResults,
...
export const AnalysisSidebar: React.FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      {/* Expected Winrate Section - Main MVP Feature */}
      <div className="flex flex-col gap-2">
        <ExpectedWinrateControls
          params={controller.expectedWinrate.params}
          onParamsChange={controller.expectedWinrate.updateParams}
          isCalculating={controller.expectedWinrate.progress.isCalculating}
          onStartCalculation={controller.expectedWinrate.startCalculation}
          onStopCalculation={controller.expectedWinrate.stopCalculation}
          analysisEnabled={analysisEnabled}
        />
        {controller.expectedWinrate.results.length > 0 && (
          <ExpectedWinrateResults
            results={controller.expectedWinrate.results}
            progress={controller.expectedWinrate.progress}
            analysisEnabled={analysisEnabled}
