/**
 * Moves Container Component
 *
 * Displays the move list for a chess game in a scrollable container.
 * Shows move numbers, piece movements, and optional classification icons
 * (blunders, inaccuracies, excellent moves).
 *
 * Used in the ExpectedEval MVP to show game moves in analysis mode.
 */
...
/**
 * Props for the MovesContainer component
