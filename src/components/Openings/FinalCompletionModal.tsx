...
const MoveQualityDistribution: React.FC<{
  ...
  isMobile?: boolean
}> = ({ completedDrills, isMobile = false }) => {
...
export const FinalCompletionModal: React.FC<Props> = ({
    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="red-scrollbar flex w-1/2 flex-col overflow-y-auto border-r border-white/10 p-8">
          <h3 className="mb-6 text-2xl font-semibold">Move Quality Overview</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between py-2">
                <span className="text-base text-secondary">Total Blunders</span>
  ...
  const MobileLayout = () => (
    <motion.div
      ...
      animate={{ opacity: 1, scale: 1 }}
      exit={{ opacity: 0, scale: 0.95 }}
      className="relative flex h-[95vh] w-[95vw] flex-col overflow-hidden rounded-lg bg-background-1 shadow-2xl"
    >
      {/* Header */}
      <div className="border-b border-white/10 p-4 text-center">
        <div className="mb-2">
          <span className="material-symbols-outlined text-5xl text-human-4">
            emoji_events
          </span>
        </div>
        ...
        <p className="mt-2 text-sm text-secondary">
          Analysis of your {totalDrills} opening drills
        </p>
      </div>

      {/* Content - Scrollable Single Column */}
      <div className="red-scrollbar flex-1 overflow-y-auto p-4">
        {/* Move Quality Distribution */}
        <div className="mb-6">
          <h3 className="mb-4 text-lg font-semibold">Move Quality Overview</h3>
          <MoveQualityDistribution completedDrills={completedDrills} isMobile />
        </div>

        {/* Performance Summary */}
        <div className="mb-6">
          <h4 className="mb-3 text-base font-medium">Performance Summary</h4>
          <div className="space-y-3">
            <div className="flex justify-between py-2">
            ...
            <div className="flex justify-between py-2">
              <span className="text-sm text-secondary">Total Blunders</span>
        ...
        {/* Performance Highlights */}
        <div className="mb-6">
          <h3 className="mb-4 text-lg font-semibold">Performance Highlights</h3>
          ...
          {worstPerformance && (
            <div className="mb-4">
              <div className="mb-2 flex items-center gap-2">
                <span className="text-xl">📚</span>
                <h4 className="text-base font-medium text-yellow-400">
                  Room for Improvement
                </h4>
              </div>
              <p className="mb-1 text-sm text-primary">
        ...
        {/* All Completed Drills */}
        <div>
          <h4 className="mb-3 text-base font-medium">All Completed Drills</h4>
          <div className="space-y-3">
            {completedDrills.map((drill, index) => (
              <div
                key={drill.selection.id}
