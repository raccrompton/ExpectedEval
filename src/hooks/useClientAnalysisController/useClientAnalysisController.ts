...
import { useStockfishEngine, useMaiaEngine, useClientGameController } from '..'
...
export const useClientAnalysisController = (game: AnalyzedGame) => {
  const controller = useClientGameController(
